...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6345005799726646017) {
        if (checkMobile()) {
...
function ua(e) {
    ...
    if (r = e.match(/FireFox\/([^\s]+)/ig)) {
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_ucweb"><i class="fa fa-globe"></i> 百度浏览��?'
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_qq"><i class="fa fa-qq"></i> QQ浏览��?'
        /*.split('/')[0]*/
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_mi"><i class="fa fa-globe"></i> Miui浏览��?'
        /*.split('/')[0]*/
